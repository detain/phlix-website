/* ============================================================
   ...
   Neon Cyberpunk effects, mobile nav, scroll animations
...
(function () {
  ...
  function initNeonFlicker() {
    const neonElements = document.querySelectorAll('.glitch');

    if (!neonElements.length) return;

    // Check for reduced motion preference
    const prefersReducedMotion = window.matchMedia('(prefers-reduced-motion: reduce)').matches;
    if (prefersReducedMotion) return;

    neonElements.forEach(function (el) {
      ...
      function scheduleNextFlicker() {
        ...
        setTimeout(triggerFlicker, delay);
      }
