  ...
  function initHeaderScroll() {
    ...
    window.addEventListener('scroll', function() {
      ...
      if (currentScroll > 100) {
        header.style.boxShadow = '0 4px 20px rgba(0, 0, 0, 0.4), 0 0 40px rgba(0, 212, 170, 0.1)';
      } else {
        header.style.boxShadow = '0 4px 20px rgba(0, 0, 0, 0.3), 0 0 40px rgba(0, 212, 170, 0.05)';
      }
    }, { passive: true });
  }
