/* ============================================================
   ...
   Electric Blue Cyber effects, mobile nav, scroll animations
...
(function () {
  ...
  function initMobileNav() {
    ...
    function openNav() {
      ...
      const first = menu.querySelector(focusableSelectors);
  ...
  function initNeonPulse() {
    const pulseElements = document.querySelectorAll('.neon-cursor');
