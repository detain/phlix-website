/**
 * main.js — Retro Film Reel V2 (50s Movie Theater)
...
(function() {
  ...
  function initScrollAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.feature-card, .client-card, .download-card, .plugin-card, .ecosystem-card');
