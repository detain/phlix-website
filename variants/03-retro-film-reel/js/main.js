/**
 * main.js
 * Mobile nav toggle with focus trap, smooth scroll, marquee animations
...
(function() {
  ...
  // Enhanced marquee effect for header (brand "Do": retro marquee lights)
  function initMarqueeLights() {
    const lights = document.querySelectorAll('.marquee-light');
