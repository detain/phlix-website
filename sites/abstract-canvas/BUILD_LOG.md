...
| ~~Palette overlaps a corner of content at 320px~~ — **RESOLVED**         | ROUND-1 #3 measured what this row waved away: the companion _did_ cover "Set Up Your Studio" at five phone sizes. It now measures its own footprint and steps aside while any control is under it (`js/main.js` `guardPalette`), verified over 10 viewports after the timers fire. |
...
`REGEN_PLAN.md` §7. Verification: `selfcheck` PASS, `render-check` PASS (9 pages × 4 viewports +
